    ...
    <div className="animate-fade-in" style={{ margin: 'auto', textAlign: 'center', padding: '1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '800px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', width: '100%', marginBottom: '2rem' }}>
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(11,15,25,0.75), rgba(11,15,25,0.95)), url(/pitch_card_bg.png) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(16,185,129,0.3), rgba(11,15,25,0.95)), url(/pitch_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(16,185,129,0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(11,15,25,0.75), rgba(11,15,25,0.95)), url(/pitch_card_bg.png) center/cover no-repeat';
          }}
        >
        ...
        <div 
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(168,85,247,0.3), rgba(11,15,25,0.95)), url(/blind_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(145deg, rgba(236,72,153,0.1) 0%, rgba(236,72,153,0.02) 100%)',
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(145deg, rgba(234,179,8,0.1) 0%, rgba(234,179,8,0.02) 100%)',
