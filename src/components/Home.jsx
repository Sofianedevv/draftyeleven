    ...
    <div className="animate-fade-in" style={{ margin: 'auto', textAlign: 'center', padding: '1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '800px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', width: '100%', marginBottom: '2rem' }}>
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/pitch_card_bg.jpg) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(169, 181, 177, 0.3), rgba(5,16,9,0.95)), url(/pitch_card_bg.jpg) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(167, 187, 181, 0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/pitch_card_bg.jpg) center/cover no-repeat';
          }}
        >
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/street_card_bg.jpg) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(245,158,11,0.3), rgba(5,16,9,0.95)), url(/street_card_bg.jpg) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(245,158,11,0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/street_card_bg.jpg) center/cover no-repeat';
          }}
        >
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/blind_card_bg.png) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(247, 166, 85, 0.3), rgba(5,16,9,0.95)), url(/blind_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(247, 169, 85, 0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/blind_card_bg.png) center/cover no-repeat';
          }}
        >
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/bench_card_bg.png) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(236,72,153,0.3), rgba(5,16,9,0.95)), url(/bench_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(236,72,153,0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/bench_card_bg.png) center/cover no-repeat';
          }}
        >
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/mystery_card_bg.png) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(234,179,8,0.3), rgba(5,16,9,0.95)), url(/mystery_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(234,179,8,0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/mystery_card_bg.png) center/cover no-repeat';
          }}
        >
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/prix_card_bg.png) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(16,185,129,0.3), rgba(5,16,9,0.95)), url(/prix_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(16,185,129,0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/prix_card_bg.png) center/cover no-repeat';
          }}
        >
          <div style={{ background: 'rgba(16,185,129,0.2)', padding: '1rem', borderRadius: '50%' }}>
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/intrus_card_bg.png) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(239,68,68,0.3), rgba(5,16,9,0.95)), url(/intrus_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(239,68,68,0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/intrus_card_bg.png) center/cover no-repeat';
          }}
        >
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/joue_avec_card_bg.png) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(14,165,233,0.3), rgba(5,16,9,0.95)), url(/joue_avec_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(14,165,233,0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/joue_avec_card_bg.png) center/cover no-repeat';
          }}
        >
        ...
        <div 
          ...
          className="mode-card"
          style={{
            background: 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/plus_moins_card_bg.png) center/cover no-repeat',
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(168,85,247,0.3), rgba(5,16,9,0.95)), url(/plus_moins_card_bg.png) center/cover no-repeat';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(168,85,247,0.3)';
            e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(5,16,9,0.75), rgba(5,16,9,0.95)), url(/plus_moins_card_bg.png) center/cover no-repeat';
          }}
        >
